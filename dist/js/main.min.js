...
exports.autocomplete = exports.filterNames = undefined;
...
},{"jquery-ui/ui/widgets/autocomplete":1}],5:[function(require,module,exports){
(function (global){
'use strict';
...
window.click = function () {
    (0, _jquery2.default)('html, body').animate({
        scrollTop: (0, _jquery2.default)("#list-view").offset().top
    }, 'slow');
};

// Place Object

var Place = function Place(place) {
...
window.initMap = function () {
    ...
    marker = function marker(markerOptions) {
...
var KoViewModel = function KoViewModel() {
    var self = this;
    window.venuePhone = _requests.venuePhone;
    window.infoError = _requests.infoError;
    window.infoRequest = _requests.infoRequest;
    window.photoRequest = _requests.photoRequest;
    window.datawindow = _requests.datawindow;
    window.ajaxError = _requests.ajaxError;
    window.venueUrl = _requests.venueUrl;
    window.infoArray = _requests.infoArray;
    window.url = _requests.url;
    window.visiblePhotos = _requests.visiblePhotos;
    window.flickrImg = _requests.flickrImg;
    window.ownerId = _requests.ownerId;
    ...
    _model2.default.forEach(function (place) {
        self.allPlaces().push(new Place(place));
    });

    // Build Markers via the Maps API and place them on the map.

    var _loop = function _loop(place) {
        markerOptions = {
        ...
        place.marker.addListener('click', function () {
            ...
            (0, _requests.infoRequest)(place);
            infowindow.setContent((0, _requests.photoRequest)(place));
        });
    };
    ...
    try {
        for (var _iterator = self.allPlaces()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    try {
        for (var _iterator2 = self.allPlaces()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    try {
        for (var _iterator3 = self.allPlaces()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            var _place = _step3.value;

            _autocomplete.filterNames.push(_place.name);
        }
...
},{"./autocomplete":4,"./map":6,"./model":7,"./requests":8,"jquery":2,"knockout":3}],6:[function(require,module,exports){
"use strict";
...
exports.ownerId = exports.flickrImg = exports.visiblePhotos = exports.url = exports.infoArray = exports.venuePhone = exports.venueUrl = exports.infoError = exports.ajaxError = exports.datawindow = exports.photoRequest = exports.infoRequest = undefined;
...
exports.infoRequest = infoRequest = function infoRequest(place) {
    // reset error status
    ajaxError(false);
    infoError(false);
    ...
    _jquery2.default.getJSON(foursquareUrl, function (data) {
...
exports.photoRequest = photoRequest = function photoRequest(place) {
    ...
    _jquery2.default.getJSON(flickrAPI, {
        api_key: flickrKey,
        extras: "geo",
        has_geo: 1,
        per_page: 3,
        ...
        if (data.photos.total != '0') {
            ...
            exports.datawindow = datawindow = infoArray() + '<br><br>' + '<img class="window-img" ' + photoArray[0] + photoArray[1];
        } else {
            exports.datawindow = datawindow = infoArray() + '<p class="info-error">No photos found for this location.</p>';
            clearTimeout(place.apiTimeout);
            ajaxError(true);
        }
    }).fail(function () {
...
exports.photoRequest = photoRequest;
exports.datawindow = datawindow;
exports.ajaxError = ajaxError;
exports.infoError = infoError;
exports.venueUrl = venueUrl;
exports.venuePhone = venuePhone;
exports.infoArray = infoArray;
exports.url = url;
exports.visiblePhotos = visiblePhotos;
exports.flickrImg = flickrImg;
exports.ownerId = ownerId;

},{"jquery":2,"knockout":3}]},{},[5])
